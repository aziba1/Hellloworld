        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                 <!-- ============================================================== -->
                <?php 
        $studDetails = $studPort->conn->query("select * from staff_profile where user_id = '" . $_GET['id'] . "'") or die($stud_profile->conn->error);
                        ...
                        <div class="card">
                           <div class="col-lg-7">
                            ...
                            <form class="form-horizontal" method="post" action="login.php?action=Create student profile" id="studProfile">
                                <div class="card-body">
                                    <h4 class="card-title" style="padding: 30px 0;">Staff Personal Info</h4>
                                    <div class="edit-tab">
                                     <!--   
                            ...
                            -->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="staff_no" readonly value="<?php echo $rowDetails["staff_no"]; ?>" name="staff_no" placeholder="Student Registeration Number">
                                        </div>
                                    </div>
                                    <div class="form-group row">
